...
# Custom headers (pretend like a real browser)
HEADERS = {
...
# Proxy settings (HTTP & HTTPS) - replace with your proxy
PROXIES = {
    "http": "http://username:password@yourproxy:8080",
    "https": "http://username:password@yourproxy:8080",
}
